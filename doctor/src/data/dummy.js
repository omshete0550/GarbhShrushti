...
async function handleAccept(_id) {
  ...
  const resp = await fetch(
    "http://localhost:8800/api/appointments/manageAppointments",
    {
      method: "POST",
      headers: {
...
export const customersGrid = [
  ...
  },
  {
    ...
    template: (rowData) => (
      <img
        src="https://png.pngtree.com/png-vector/20221215/ourmid/pngtree-wrong-icon-png-image_6525689.png"
  ...
  },
  {
    ...
    template: (rowData) => (
      <Link to={`/SinglePatient/${rowData.patientId}`}>
        <div style={{ cursor: "pointer" }}>{rowData.patientId}</div>
      </Link>
    ),
  },
];
